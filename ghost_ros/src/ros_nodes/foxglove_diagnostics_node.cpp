...
namespace ghost_ros
{
    FoxgloveDiagnosticsNode::FoxgloveDiagnosticsNode() : rclcpp::Node("foxglove_diagnostics_node"){
        ...
        // Subscriptions
        v5_competition_state_sub_ = create_subscription<ghost_msgs::msg::V5CompetitionState>(
            "v5/competition_state",
            10,
            std::bind(&FoxgloveDiagnosticsNode::V5CompetitionStateCallback, this, _1));
    ...
    void FoxgloveDiagnosticsNode::V5CompetitionStateCallback(const ghost_msgs::msg::V5CompetitionState::SharedPtr msg){
