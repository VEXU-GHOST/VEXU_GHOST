...
extern "C" DeviceConfigMap* getRobotConfig(void) {
	DeviceConfigMap* robot_config = new DeviceConfigMap;
	robot_config->use_secondary_joystick = false;

	std::shared_ptr<RotationSensorDeviceConfig> rotation_sensor_2 = std::make_shared<RotationSensorDeviceConfig>();
	...
	std::shared_ptr<RotationSensorDeviceConfig> rotation_sensor_1 = std::make_shared<RotationSensorDeviceConfig>();
	...
	default_motor->encoder_units = ghost_encoder_unit::ENCODER_COUNTS;
	default_motor->gearset = ghost_gearset::GEARSET_200;
	default_motor->brake_mode = ghost_brake_mode::BRAKE_MODE_COAST;
	...
	test_motor->encoder_units = ghost_encoder_unit::ENCODER_COUNTS;
	test_motor->gearset = ghost_gearset::GEARSET_200;
	test_motor->brake_mode = ghost_brake_mode::BRAKE_MODE_COAST;
	...
	left_drive_motor->encoder_units = ghost_encoder_unit::ENCODER_COUNTS;
	left_drive_motor->gearset = ghost_gearset::GEARSET_200;
