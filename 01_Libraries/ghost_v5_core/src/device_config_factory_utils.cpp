...
void generateCodeFromRobotConfig(std::shared_ptr<DeviceConfigMap> config_ptr, std::string output_filepath){
	...
	output_file << "#include \"ghost_v5_core/base/device_config_map.hpp\"\n";
	output_file << "#include \"ghost_v5_core/motor/motor_device_interface.hpp\"\n";
	output_file << "#include \"ghost_v5_core/rotation_sensor/rotation_sensor_device_interface.hpp\"\n";
	output_file << "\n";
