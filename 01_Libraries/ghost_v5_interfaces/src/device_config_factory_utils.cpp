...
void generateCodeFromRobotConfig(std::shared_ptr<DeviceConfigMap> config_ptr, std::string output_filepath){
	...
	output_file << "#include \"ghost_v5_interfaces/base/device_config_map.hpp\"\n";
	output_file << "#include \"ghost_v5_interfaces/motor/motor_device_interface.hpp\"\n";
	output_file << "#include \"ghost_v5_interfaces/rotation_sensor/rotation_sensor_device_interface.hpp\"\n";
	output_file << "\n";
