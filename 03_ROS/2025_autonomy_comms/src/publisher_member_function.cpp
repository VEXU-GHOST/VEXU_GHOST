...
// I'm preserving the original example code from ROS2 here
...
// The following is the Vexlink example code in the manual
...
{
  // wait for link
  while(!LinkA.isLinked()) this_thread::sleep_for(50);
