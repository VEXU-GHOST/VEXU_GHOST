...
void update_actuators()
{
  ...
  if (count++ % 100 == 0) {
    ...
    v5_globals::screen_interface_ptr->addToPrintQueue("conveyor_motor: ", conveyor_current_lim);

    auto ground_pickup_current_lim = v5_globals::motor_interfaces["ground_pickup_motor"]->getMotorInterfacePtr()->get_current_limit();
    v5_globals::screen_interface_ptr->addToPrintQueue("ground_pickup_motor: ", ground_pickup_current_lim);
  }
...
void initialize()
{
  try {
    ...
    v5_globals::robot_hardware_interface_ptr = std::make_shared<RobotHardwareInterface>(
      v5_globals::robot_device_config_map_ptr, V5_BRAIN);
    v5_globals::serial_node_ptr = std::make_shared<V5SerialNode>(
      v5_globals::robot_hardware_interface_ptr);
        ...
        case device_type_e::MOTOR:
          {
            ...
            v5_globals::motor_interfaces[device_name] =
              std::make_shared<ghost_v5::V5MotorInterface>(motor_config_ptr);
          }
          break;
        ...
        case device_type_e::ROTATION_SENSOR:
          {
            ...
            v5_globals::encoders[device_name] = std::make_shared<pros::Rotation>(
              rotation_sensor_config_ptr->port);
        ...
        case device_type_e::INERTIAL_SENSOR:
          {
            ...
            v5_globals::imus[device_name] = std::make_shared<pros::Imu>(
              inertial_sensor_config_ptr->port);
